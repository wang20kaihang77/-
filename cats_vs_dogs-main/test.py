...
def evaluate_one_image():
    # 修改成自己测试集的文件夹路径
    test_dir = 'F:/junior/ProjectDesign/MechineLearning/cats_vs_dogs-main/data/test/'
    ...
    with tf.Graph().as_default():    # 参考：https://blog.csdn.net/nanhuaibeian/article/details/101862790
        ...
        # 修改成自己训练好的模型路径
        logs_train_dir = 'F:/junior/ProjectDesign/MechineLearning/cats_vs_dogs-main/log/'
