...
train_dir = 'F:/junior/ProjectDesign/MechineLearning/data/train/'  # 训练集的文件夹路径
logs_train_dir = 'F:/junior/ProjectDesign/MechineLearning/cats_vs_dogs-main/log/'  # 记录训练过程与保存模型的路径
